...
export function Backpack({
  ...
  return (
    <div className="group relative p-5 bg-gradient-to-br from-orange-500 via-orange-600 to-amber-600 text-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-orange-400/30 min-w-[200px]">
