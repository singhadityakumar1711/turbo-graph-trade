...
export function Hyperliquid({
  ...
  return (
    <div className="group relative p-5 bg-gradient-to-br from-emerald-500 via-emerald-600 to-teal-600 text-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-emerald-400/30 min-w-[200px]">
